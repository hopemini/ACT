...
for _iter in range(args.iteration):
    ...
    #srcp = torchtext.data.Field(batch_first=True, sequential=True, use_vocab=False,
    #        pad_token=None, unk_token=None, preprocessing=torchtext.data.Pipeline(lambda x: int(x)))
    ...
    # train
    t = Trainer(loss=loss, batch_size=256,
                checkpoint_every=50,
                print_every=100,
