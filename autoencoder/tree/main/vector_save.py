...
for _iter in range(args.iteration):
    ...
    save_23_path = "../../data/tree_23_" + str(_iter) + "/"
    if not os.path.exists(save_23_path):
        os.mkdir(save_23_path)
    save_23_path = save_23_path + "tree_23_" + str(_iter)

    save_34_path = "../../data/tree_34_" + str(_iter) + "/"
    if not os.path.exists(save_34_path):
        os.mkdir(save_34_path)
    save_34_path = save_34_path + "tree_34_" + str(_iter)
